...
from .nodes_iteration_counter import NODE_CLASS_MAPPINGS as WAN_ITERATION_COUNTER_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as WAN_ITERATION_COUNTER_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(WAN_ITERATION_COUNTER_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(WAN_ITERATION_COUNTER_NODE_DISPLAY_NAME_MAPPINGS)
